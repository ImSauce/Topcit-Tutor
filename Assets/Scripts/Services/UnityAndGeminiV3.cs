...
public class UnityAndGeminiV3: MonoBehaviour
{
    ...
    private string apiEndpoint = "https://generativelanguage.googleapis.com/v1beta/models/gemini-3.5-flash-lite:generateContent"; // Edit it and choose your prefer model
        ...
        using (UnityWebRequest www = new UnityWebRequest(url, "POST")){
            ...
            if (www.result != UnityWebRequest.Result.Success) {
                Debug.LogError(www.error);
                    ...
                    Debug.LogError("Unity Error: " + www.error);
    ...
    private IEnumerator SendChatRequestToGemini(string newMessage)
{
    ...
    if (contentsList.Count > 6)
    {
        contentsList.RemoveRange(0, contentsList.Count - 6);
    }
    ...
    using (UnityWebRequest www = new UnityWebRequest(url, "POST"))
    {
        ...
        else
        {
            ...
            TextResponse response =
                JsonUtility.FromJson<TextResponse>(
                ...
                response.candidates[0].content.parts.Length > 0)
            {
                ...
                // Keep only the latest 6 messages again
                if (contentsList.Count > 6)
                {
                    contentsList.RemoveRange(
                        0,
                        contentsList.Count - 6
                    );
                }
